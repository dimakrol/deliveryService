...
const {indexAction, showAction, createAction, updateAction, deleteAction} = require('./orderController');
const baseValidator = require('../../helpers/baseValidator');
const {indexValidator, createValidator, updateValidator, idValidator} = require('./orderValidators');
